...
(function() {
    ...
    require([
        ...
        'BootstrapCarousel/widget/lib/jquery'
        ...
        // Declare widget.
        return declare('BootstrapCarousel.widget.BootstrapCarousel', [ _WidgetBase, _Widget, _Templated, _jQuery], {
            ...
            update: function (obj, callback) {
                // startup
                console.log('BootstrapCarousel - update');
                ...
                if (obj === null) {
                    ...
                    console.log('BootstrapCarousel  - update - We did not get any context object!');
                } else {
            ...
            _createChildNodes: function () {
                ...
                console.log('BootstrapCarousel - createChildNodes events');
            },
             ...
             */
            _loadData: function () {
                var i, carouselItem , listIndicator, templateCarousel, listItem = '', indicators = '', $, path;
